...
const SOURCES = [
  ...
  { id: "azubiyo", label: "Azubiyo", badge: null, logo: <span className="text-xs font-bold text-indigo-600">A</span>, type: "maps" },
  { id: "aubiplus", label: "AUBI-plus", badge: null, logo: <span className="text-xs font-bold text-green-600">A+</span>, type: "maps" },
  { id: "ausbildungde", label: "Ausbildung.de", badge: "New", logo: <span className="text-xs font-bold text-blue-600">Ad</span>, type: "maps" },
  { id: "azubica", label: "Azubica", badge: "New", logo: <span className="text-xs font-bold text-purple-600">Az</span>, type: "maps" },
  ...
  { id: "linkedin", label: "LinkedIn Jobs", badge: null, logo: <span className="text-xs font-bold text-blue-700">Li</span>, type: "linkedin" },
  { id: "xing", label: "XING Jobs", badge: null, logo: <span className="text-xs font-bold text-teal-600">X</span>, type: "xing" },
  { id: "stepstone", label: "StepStone", badge: null, logo: <span className="text-xs font-bold text-green-700">SS</span>, type: "maps" },
  { id: "jobware", label: "Jobware", badge: null, logo: <span className="text-xs font-bold text-gray-600">Jw</span>, type: "maps" },
  { id: "monster", label: "Monster", badge: null, logo: <span className="text-xs font-bold text-purple-700">M</span>, type: "maps" },
  { id: "kimeta", label: "Kimeta", badge: null, logo: <span className="text-xs font-bold text-pink-600">K</span>, type: "maps" },
  { id: "jobboerse_de", label: "Jobbörse.de", badge: null, logo: <span className="text-xs font-bold text-orange-600">Jb</span>, type: "maps" },
  { id: "stellenanzeigen_de", label: "Stellenanzeigen.de", badge: null, logo: <span className="text-xs font-bold text-red-600">SA</span>, type: "maps" },
  { id: "meinestadt", label: "Meinestadt.de", badge: null, logo: <span className="text-xs font-bold text-yellow-600">Ms</span>, type: "maps" },
  { id: "jooble", label: "Jooble", badge: null, logo: <span className="text-xs font-bold text-blue-500">J</span>, type: "maps" },
  { id: "glassdoor", label: "Glassdoor", badge: null, logo: <span className="text-xs font-bold text-green-800">Gd</span>, type: "maps" },
  { id: "jobmensa", label: "Jobmensa", badge: null, logo: <span className="text-xs font-bold text-emerald-600">Jm</span>, type: "maps" },
  { id: "workwise", label: "Workwise", badge: null, logo: <span className="text-xs font-bold text-indigo-500">Ww</span>, type: "maps" },
  { id: "absolventa", label: "Absolventa", badge: null, logo: <span className="text-xs font-bold text-cyan-600">Ab</span>, type: "maps" },
  { id: "berufsstart", label: "Berufsstart", badge: null, logo: <span className="text-xs font-bold text-amber-600">Bs</span>, type: "maps" },
  { id: "meinpraktikum", label: "MeinPraktikum", badge: null, logo: <span className="text-xs font-bold text-lime-600">Mp</span>, type: "maps" },
  { id: "praktikum_info", label: "Praktikum.info", badge: null, logo: <span className="text-xs font-bold text-sky-600">Pi</span>, type: "maps" },
  { id: "praktika_de", label: "Praktika.de", badge: null, logo: <span className="text-xs font-bold text-violet-600">Pd</span>, type: "maps" },
  { id: "workingstudentjobs_de", label: "WorkingStudentJobs.de", badge: null, logo: <span className="text-xs font-bold text-fuchsia-600">Ws</span>, type: "maps" },
  { id: "staufenbiel", label: "Staufenbiel", badge: null, logo: <span className="text-xs font-bold text-rose-600">St</span>, type: "maps" },
  { id: "eures", label: "EURES", badge: null, logo: <span className="text-xs font-bold text-blue-800">Eu</span>, type: "maps" },
  { id: "make_it_in_germany", label: "Make-it-in-Germany", badge: null, logo: <span className="text-xs font-bold text-red-700">MiG</span>, type: "maps" },
  { id: "interamt", label: "Interamt", badge: null, logo: <span className="text-xs font-bold text-slate-600">In</span>, type: "maps" },
  { id: "bund_de", label: "Bund.de", badge: null, logo: <span className="text-xs font-bold text-gray-700">Bu</span>, type: "maps" },
  { id: "lehrstellenradar", label: "Lehrstellenradar", badge: null, logo: <span className="text-xs font-bold text-orange-700">Lr</span>, type: "maps" },
  { id: "handwerk_de", label: "Handwerk.de", badge: null, logo: <span className="text-xs font-bold text-amber-700">Hw</span>, type: "maps" },
  { id: "ihk", label: "IHK Lehrstellenbörse", badge: null, logo: <span className="text-xs font-bold text-yellow-700">IHK</span>, type: "maps" },
  { id: "talent", label: "Talent.com", badge: null, logo: <span className="text-xs font-bold text-teal-700">Tc</span>, type: "maps" },
  { id: "joblift", label: "Joblift", badge: null, logo: <span className="text-xs font-bold text-cyan-700">Jl</span>, type: "maps" },
  { id: "yourfirm", label: "Yourfirm", badge: null, logo: <span className="text-xs font-bold text-indigo-700">Yf</span>, type: "maps" },
  { id: "yourfirm_ausbildung", label: "Yourfirm Ausbildungsbörse", badge: null, logo: <span className="text-xs font-bold text-indigo-800">YfA</span>, type: "maps" },
  { id: "connectoor", label: "Connectoor", badge: null, logo: <span className="text-xs font-bold text-emerald-700">Co</span>, type: "maps" },
  { id: "jobtensor", label: "Jobtensor", badge: null, logo: <span className="text-xs font-bold text-pink-700">Jt</span>, type: "maps" },
  { id: "germantechjobs", label: "GermanTechJobs", badge: null, logo: <span className="text-xs font-bold text-sky-700">GTJ</span>, type: "maps" },
  { id: "berlin_startup_jobs", label: "Berlin Startup Jobs", badge: null, logo: <span className="text-xs font-bold text-gray-800">BSJ</span>, type: "maps" },
  { id: "arbeitnow", label: "Arbeitnow", badge: null, logo: <span className="text-xs font-bold text-blue-900">An</span>, type: "maps" },
  { id: "wellfound", label: "Wellfound", badge: null, logo: <span className="text-xs font-bold text-emerald-800">Wf</span>, type: "maps" },
  { id: "relocate_me", label: "Relocate.me", badge: null, logo: <span className="text-xs font-bold text-teal-800">Rm</span>, type: "maps" },
  { id: "jobvector", label: "Jobvector", badge: null, logo: <span className="text-xs font-bold text-violet-700">Jv</span>, type: "maps" },
  { id: "academics", label: "Academics", badge: null, logo: <span className="text-xs font-bold text-cyan-800">Ac</span>, type: "maps" },
  { id: "medi_jobs", label: "Medi-Jobs", badge: null, logo: <span className="text-xs font-bold text-rose-700">Mj</span>, type: "maps" },
  { id: "hotelcareer", label: "Hotelcareer", badge: null, logo: <span className="text-xs font-bold text-amber-800">Hc</span>, type: "maps" },
  { id: "gastrojobs", label: "Gastrojobs", badge: null, logo: <span className="text-xs font-bold text-orange-800">Gj</span>, type: "maps" },
  { id: "logistik_jobs", label: "Logistik-Jobs", badge: null, logo: <span className="text-xs font-bold text-slate-700">Lj</span>, type: "maps" },
  { id: "salesjob", label: "Salesjob", badge: null, logo: <span className="text-xs font-bold text-blue-600">Sj</span>, type: "maps" },
  { id: "greenjobs", label: "Greenjobs", badge: null, logo: <span className="text-xs font-bold text-green-600">Gj</span>, type: "maps" },
  { id: "unicum", label: "UNICUM Karrierezentrum", badge: null, logo: <span className="text-xs font-bold text-fuchsia-700">Uni</span>, type: "maps" },
  { id: "campusjaeger", label: "Campusjäger", badge: null, logo: <span className="text-xs font-bold text-lime-700">Cj</span>, type: "maps" },
  { id: "jobstairs", label: "Jobstairs", badge: null, logo: <span className="text-xs font-bold text-yellow-600">Js</span>, type: "maps" },
  { id: "heyjobs", label: "HeyJobs", badge: null, logo: <span className="text-xs font-bold text-pink-800">Hj</span>, type: "maps" },
  { id: "hokify", label: "Hokify", badge: null, logo: <span className="text-xs font-bold text-rose-800">Ho</span>, type: "maps" },
];
    ...
    <div className="flex flex-col items-center justify-center min-h-[60vh]">
      ...
      <div className="w-full max-w-2xl bg-gray-50 rounded-2xl border border-gray-200 p-4 sm:p-6">
        <div className="space-y-2 max-h-[300px] overflow-y-auto">
          {logs.filter((log) => log.type === "success").map((log, i) => (
            <div key={i} className="flex items-center gap-2 text-sm">
              <IconCheck />
              <span className="text-green-600 font-medium">{log.message}</span>
            </div>
          ))}
        </div>
      </div>
...
export default function Datenextraktion() {
  ...
  const handleStop = async () => {
    ...
    try {
      await fetch(`${API_BASE}/extract/stop`, { method: "POST" });
    } catch (e) {
      console.error("Stop request failed:", e);
    }
    // Keep extracting=true so the ExtractionScreen stays visible
    // until the backend returns partial results.
  };
