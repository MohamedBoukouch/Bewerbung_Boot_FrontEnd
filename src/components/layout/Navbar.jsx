      ...
      BEWERBUNGEN DEUTSCHLAND
        ...
        <div className="flex items-center gap-1 md:gap-1.5 lg:gap-2 shrink-0">
          ...
          <button
            ...
            className="w-7 h-7 md:w-8 md:h-8 flex items-center justify-center rounded-full border border-gray-200 hover:bg-gray-50 dark:border-gray-700 dark:hover:bg-gray-800 transition-colors text-gray-400 hover:text-gray-600 dark:text-gray-300 dark:hover:text-white"
          >
            {theme === "dark" ? (
